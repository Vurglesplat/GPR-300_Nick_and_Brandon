...
//	a3mat4 projectionBiasMatInv = activeCamera->projectorMatrixStackPtr->projectionBiasMatInverse;
	...
	case ssfx_renderModePhongDS:
		...
		a3framebufferBindColorTexture(demoState->fbo_c16x4_d24s8, a3tex_unit04, 0); //0 is texture coords
		a3framebufferBindColorTexture(demoState->fbo_c16x4_d24s8, a3tex_unit05, 1); //1 is normal coords
		a3framebufferBindDepthTexture(demoState->fbo_c16x4_d24s8, a3tex_unit07); //1 is normal coords
		//...
		break;
